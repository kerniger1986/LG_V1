    ...
    <>
      <section className="bg-[#2F5D50] text-[#EFF2ED]">
        <div className="mx-auto max-w-5xl px-6 py-16 sm:py-20">
          <div className="grid gap-10 lg:grid-cols-[58%_1fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-xl text-[#EFF2ED]/90">
                Beiträge rund um Erbschaft, Ruhestand und Immobilienverkauf in
                Bad Honnef und dem Rhein-Sieg-Kreis.
              </p>
              <div className="mt-8 max-w-sm lg:hidden">
                <RegionPhoto />
              </div>
            </div>
